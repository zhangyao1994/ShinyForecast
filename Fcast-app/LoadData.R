...
NewModelNames <- c("3 ARIMA","1 Actual","9 Ensemble","8 MRP_Fcast","4 Prophet","7 TBATS","6 LinearModel","5 RandomForest","2 Xgboost")
...
write_feather(CFG_fcast.joined,"~/GitHub/ShinyPractice/Fcast-app/data/CFG_fcast_v2.feather")
...
write_feather(All_fcast_CV,"~/GitHub/ShinyPractice/Fcast-app/data/All_fcast_cv_v2.feather")
